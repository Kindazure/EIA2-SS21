namespace end {
   ...
   */
   ...
   let allNames: string[] = ["Morgana", "Nami", "Tristana", "Jhin", "Neeko", "Katarina", "Irelia", "Evelyn", "Kha'zix", "Fiora", "Garen", "Blitzcrank", "Nautilus", "MissFortune", "Heimerdinger", "Vladimir", "Yasuo", "Yone", "Fiddlesticks", "Shaco", "Tryndamere", "Ornn", "Soraka", "Mordekaiser", "Vayne", "Shen", "Diana", "Twitch", "Alistar", "ThamKench", "Lulu", "Qiana"];
   ...
   function saveSelected(): void {
      ...
      if (selectedTeam == 0) {
         ...
         // weil im array 10 anderes Team ist
   ...
   function draw(): void {
      ...
      if (touchingPlayer) {
         playerOnBall.innerHTML = "Player on Ball: " + touchingPlayer.name + " || Speed: " + touchingPlayer.speed + " || Acuracy: " + (touchingPlayer.acuracy * 100).toPrecision(2) + "%";
      }

...
(function (end) {
    ...
    */
    ...
    let allNames = ["Morgana", "Nami", "Tristana", "Jhin", "Neeko", "Katarina", "Irelia", "Evelyn", "Kha'zix", "Fiora", "Garen", "Blitzcrank", "Nautilus", "MissFortune", "Heimerdinger", "Vladimir", "Yasuo", "Yone", "Fiddlesticks", "Shaco", "Tryndamere", "Ornn", "Soraka", "Mordekaiser", "Vayne", "Shen", "Diana", "Twitch", "Alistar", "ThamKench", "Lulu", "Qiana"];
    let people = [];
    let touchingPlayer;
    let touching = false;
    let trikotOne;
